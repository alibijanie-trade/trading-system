...
def main() -> int:
    ...
    print(f"  {BOLD}python -c \"from app.schemas import OhlcvRowSchema, OhlcvImportResult; from app.infrastructure.data_sources import DataSource, ExcelDataSource; print('OK')\"{RESET}\n")
    info("خروجی: 'OK'")
    print()

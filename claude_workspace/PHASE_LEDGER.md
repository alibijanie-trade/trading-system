...
- **`<chat-end part18>`** = codify v2.17 (#۸۷/#۸۸ + M105 + B5 ۷/۷ + Review #۰۱۰/#۰۱۱ + این ردیف Ledger + PART19 handoff) — backfill در boot part19 (M101)
